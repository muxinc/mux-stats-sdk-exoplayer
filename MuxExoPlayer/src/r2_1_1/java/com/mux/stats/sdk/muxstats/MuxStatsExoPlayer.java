...
public class MuxStatsExoPlayer extends MuxBaseExoPlayer implements ExoPlayer.EventListener,
    ...
    private WeakReference<StreamingDrmSessionManager.EventListener> drmSessionListener;
    ...
    public void onAudioTrackUnderrun(int bufferSize, long bufferSizeMs, long elapsedSinceLastFeedMs) {
        if (audioRenderListener.get() != null) {
            audioRenderListener.get().onAudioTrackUnderrun(bufferSize, bufferSizeMs, elapsedSinceLastFeedMs);
        }
    }
    ...
    public StreamingDrmSessionManager.EventListener getStreamingDrmSessionManagerEventListener(StreamingDrmSessionManager.EventListener listener) {
        drmSessionListener = new WeakReference<>(listener);
        return this;
    }

    public MetadataRenderer.Output getMetadataRendererOutput(MetadataRenderer.Output listener) {
