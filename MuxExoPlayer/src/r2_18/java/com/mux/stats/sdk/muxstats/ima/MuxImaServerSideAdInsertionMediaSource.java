...
import static com.mux.stats.sdk.muxstats.ima.MuxImaUtil.secToMsRounded;
import static com.mux.stats.sdk.muxstats.ima.MuxImaUtil.secToUsRounded;
...
public final class MuxImaServerSideAdInsertionMediaSource extends CompositeMediaSource<Void> {
  ...
  public static final class AdsLoader {
    ...
    public static final class Builder {
      ...
      /**
       * Sets the optional {@link AdErrorListener} that will be passed to {@link
       * AdsManager#addAdErrorListener(AdErrorListener)}.
       *
       * @param adErrorListener The {@link AdErrorListener}.
       * @return This builder, for convenience.
       */
  ...
  private final class ComponentListener
      implements AdEventListener, Player.Listener, AdPlaybackStateUpdater {
  ...
  private static final class StreamPlayer implements VideoStreamPlayer {
    ...
    private final List<VideoStreamPlayerCallback> callbacks;
    private final Player player;
    private final MediaItem mediaItem;
    ...
    public void onContentCompleted() {
      for (VideoStreamPlayerCallback callback : callbacks) {
    ...
    @Override
    public void addCallback(VideoStreamPlayerCallback callback) {
      callbacks.add(callback);
    }

    @Override
    public void removeCallback(VideoStreamPlayerCallback callback) {
