...
/* package */ final class MuxAdTagLoader implements Player.Listener {
  ...
  private void updateAdProgress() {
    ...
    if (configuration.debugModeEnabled) {
      Log.d(TAG, "Ad progress: " + MuxImaUtil.getStringForVideoProgressUpdate(videoProgressUpdate));
    }
   ...
   * within the {@link MuxImaUtil.Configuration#adPreloadTimeoutMs preload timeout}.
   */
  ...
  private final class ComponentListener
    ...
    public void onAdsManagerLoaded(AdsManagerLoadedEvent adsManagerLoadedEvent) {
      ...
      pendingAdRequestContext = null;
      MuxAdTagLoader.this.adsManager = adsManager;
    ...
    public VideoProgressUpdate getContentProgress() {
      ...
      if (configuration.debugModeEnabled) {
        Log.d(
            TAG,
            "Content progress: " + MuxImaUtil.getStringForVideoProgressUpdate(videoProgressUpdate));
      }
  ...
  private class MainAdEventListener implements AdEventListener {
    ...
    @Override
    public void onAdEvent(AdEvent adEvent) {
      if (configuration.applicationAdEventListeners == null) {
        return;
      }
      for (AdEventListener l : configuration.applicationAdEventListeners) {
        l.onAdEvent(adEvent);
      }
    }
  }
  ...
  private class MainAdErrorListener implements AdErrorListener {
    ...
    @Override
    public void onAdError(AdErrorEvent adErrorEvent) {
      if (configuration.applicationAdErrorListeners == null) {
        return;
      }
      for (AdErrorListener l : configuration.applicationAdErrorListeners) {
