...
public final class MuxImaAdsLoader extends MuxImaAdsLoaderBase {
  ...
  protected void maybePreloadNextPeriodAds() {
    ...
    @Nullable MuxAdTagLoaderBase nextMuxAdTagLoader = adTagLoaderByAdsId.get(nextAdsId);
    if (nextMuxAdTagLoader == null || nextMuxAdTagLoader == currentMuxAdTagLoader) {
      return;
    }
    long periodPositionUs =
        timeline.getPeriodPositionUs(
            ...
            .second;
    nextMuxAdTagLoader.maybePreloadAds(MuxUtil.usToMs(periodPositionUs),
        MuxUtil.usToMs(period.durationUs));
  }
