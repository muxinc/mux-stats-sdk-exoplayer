...
public final class MuxImaServerSideAdInsertionUriBuilder {
  ...
  public MuxImaServerSideAdInsertionUriBuilder() {
   ...
   */
  public MuxImaServerSideAdInsertionUriBuilder setAdsId(String adsId) {
    this.adsId = adsId;
    return this;
  }
   ...
   * @return This instance, for convenience.
   */
  public MuxImaServerSideAdInsertionUriBuilder setAssetKey(@Nullable String assetKey) {
   ...
   * @return This instance, for convenience.
   */
  public MuxImaServerSideAdInsertionUriBuilder setAuthToken(@Nullable String authToken) {
   ...
   * @return This instance, for convenience.
   */
  public MuxImaServerSideAdInsertionUriBuilder setContentSourceId(@Nullable String contentSourceId) {
   ...
   * @return This instance, for convenience.
   */
  public MuxImaServerSideAdInsertionUriBuilder setVideoId(@Nullable String videoId) {
   ...
   * @return This instance, for convenience.
   */
  public MuxImaServerSideAdInsertionUriBuilder setFormat(@ContentType int format) {
   ...
   * @return This instance, for convenience.
   */
  public MuxImaServerSideAdInsertionUriBuilder setApiKey(@Nullable String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
   ...
   * @return This instance, for convenience.
   */
  public MuxImaServerSideAdInsertionUriBuilder setStreamActivityMonitorId(
   ...
   * @return This instance, for convenience.
   */
  public MuxImaServerSideAdInsertionUriBuilder setAdTagParameters(
   ...
   * @return This instance, for convenience.
   */
  public MuxImaServerSideAdInsertionUriBuilder setManifestSuffix(@Nullable String manifestSuffix) {
   ...
   * @return This instance, for convenience.
   */
  public MuxImaServerSideAdInsertionUriBuilder setContentUrl(@Nullable String contentUrl) {
   ...
   * @return This instance, for convenience.
   */
  public MuxImaServerSideAdInsertionUriBuilder setLoadVideoTimeoutMs(int loadVideoTimeoutMs) {
