...
public class HttpRequestParser {
  ...
  /**
   * 5.1 Request-Line The Request-Line begins with a method token, followed by the Request-URI and
   * the protocol version, and ending with CRLF. The elements are separated by SP characters. No CR
