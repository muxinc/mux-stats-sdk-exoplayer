...
public final class CronetDataSourceFactory extends BaseFactory {
   ...
   * @param executor            The {@link java.util.concurrent.Executor} that will perform the
   *                            requests.
   ...
   * @param executor            The {@link java.util.concurrent.Executor} that will perform the
   *                            requests.
   * @param userAgent           The user agent that will be used by the fallback {@link
   *                            HttpDataSource} if needed, or {@code null} for the fallback to use
   *                            the default user agent of the underlying platform.
   */
  public CronetDataSourceFactory(
   ...
   * @param userAgent               The user agent that will be used by the fallback {@link
   *                                HttpDataSource} if needed, or {@code null} for the fallback to
   *                                use the default user agent of the underlying platform.
   */
  public CronetDataSourceFactory(
      CronetEngineWrapper cronetEngineWrapper,
      Executor executor,
   ...
   * @param readTimeoutMs           The read timeout, in milliseconds.
   * @param resetTimeoutOnRedirects Whether the connect timeout is reset when a redirect occurs.
   * @param fallbackFactory         A {@link HttpDataSource.Factory} which is used as a fallback in
   *                                case no suitable CronetEngine can be build.
   */
  public CronetDataSourceFactory(
      CronetEngineWrapper cronetEngineWrapper,
      Executor executor,
